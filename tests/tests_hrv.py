...
def test_hrv_symdyn():
    ...
    expected_results = pd.DataFrame(
        ...
        columns =['HRV_SymDyn_EqualProb4_0V', 'HRV_SymDyn_EqualProb4_1V',
        'HRV_SymDyn_EqualProb4_2LV', 'HRV_SymDyn_EqualProb4_2UV',
        'HRV_SymDyn_EqualProb6_0V', 'HRV_SymDyn_EqualProb6_1V',
        'HRV_SymDyn_EqualProb6_2LV', 'HRV_SymDyn_EqualProb6_2UV',
